...
/**
 * Comprehensive Test: Mobile Menu & Header
 * Tests mobile header buttons and menu overlay interactions.
 */
test.describe('Mobile Menu & Header @comprehensive @desktop', () => {
  ...
  test('should open Gear Code Mapping from menu', async ({ page }) => {
    ...
    const gearCodeBtn = page.locator('.mobile-menu-btn', { hasText: 'Gear Code Mapping' });
    await gearCodeBtn.click();
    await page.waitForTimeout(500);
