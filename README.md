...
10. [Request New Items](#request-new-items)
11. [Dimensions](#dimensions)
12. [Power](#power)
13. [Data](#data)
14. [Structure](#structure)
15. [Cabling](#cabling)
16. [Layout Views](#layout-views)
17. [Canvas View](#canvas-view)
18. [Combined View](#combined-view)
19. [Gear List](#gear-list)
20. [Exports](#exports)
21. [Keyboard Shortcuts](#keyboard-shortcuts)
22. [Supported Panels](#supported-panels)
23. [Supported Processors](#supported-processors)
...
- **User accounts** — Sign in, cloud sync, and saved projects (Supabase)
...
- **Sign In** — Placeholder for future user accounts
