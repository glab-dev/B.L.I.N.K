...
/**
 * Comprehensive Mobile Test: Canvas View
 * Tests all canvas view interactions: zoom, canvas size, position, snap, export options.
 */
test.describe('Canvas View @comprehensive @mobile', () => {
  ...
  test('should zoom in with + button', async ({ page, canvasView }) => {
    await canvasView.zoomInput.scrollIntoViewIfNeeded();
  ...
  test('should zoom out with - button', async ({ page, canvasView }) => {
    ...
    await canvasView.zoomInBtn.scrollIntoViewIfNeeded();
    await canvasView.zoomIn();
    ...
    await canvasView.zoomOutBtn.scrollIntoViewIfNeeded();
